// Java program to implement Max heapArray
...
public class Demo {
    ...
    public static void main(String[] arg)
    {
        ...
        System.out.println("The Max heapArray is ");

        Demo maxHeap = new Demo(15);
